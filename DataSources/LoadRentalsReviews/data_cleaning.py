                    ...
                    for tpl2 in custom_pricing:
                        if tpl[5] <= tpl2[1] <= tpl[6]:
                            ...
                            if reservation_duration_new > reservation_duration:
                                ...
                                final_price = tpl[10] - tpl[2]
                                final_price = final_price + (price_new * reservation_duration)
                            ...
                            if tpl[11] != None:
                                applied_fees_and_discounts = tpl[11]
                                applied_fees_and_discounts.append('custom_pricing')
                            else:
