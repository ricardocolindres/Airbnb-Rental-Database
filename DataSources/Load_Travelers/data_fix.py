...
class DatabaseConn:
    ...
    def travelers_write(self):
        ...
        for traveler in list_travelers:
            ...
            SQL1 = "UPDATE users.travelers SET host=%s WHERE traveler_id = %s;"
            choosen_bool = random.choice(host)
        
            list_to_pass = [ choosen_bool, traveler]
            print(list_to_pass)
